...
function run_sda_smoother_state_L96()
    try
        ...
        args = (path * L96_test_ts, "etks", 0, 3500, 10, 1, false,
                1.0, 40, 1.00, 21, 1.02)
...
function analyze_sda_smoother_state_L96()
    try
        ...
        path = joinpath(@__DIR__, "../src/data/etks-single-iteration/") 
...
function run_mda_smoother_state_L96()
    try
        ...
        args = (path * L96_test_ts, "etks", 0, 3500, 10, 1, true,
                1.0, 40, 1.00, 21, 1.02)
        single_iteration_state(args)
        true
    catch
...
function run_sda_smoother_param_L96()
    try
        ...
        args = (path * L96_test_ts, "etks", 0, 3500, 10, 1, false, 1.0, 40, 1.0,
...
function run_mda_smoother_param_L96()
    try
        ...
        args = (path * L96_test_ts, "etks", 0, 3500, 10, 1, true, 1.0, 40, 1.0,
                0.10, 0.0010, 21, 1.02, 1.0)
        single_iteration_param(args)
        true
    catch
