...
function filter_state_exp(j)
    f = load("/data/gpfs/home/cgrudzien/da_benchmark/data/input_data/filter_state_input_args.jld")
...
function classic_smoother_state_exp(j)
    f = load("/data/gpfs/home/cgrudzien/da_benchmark/data/input_data/classic_state_smoother_input_args.jld")
    args = f["experiments"][j]
    classic_state(args)
end
...
function single_iteration_smoother_state_exp(j)
    f = load("/data/gpfs/home/cgrudzien/da_benchmark/data/input_data/single_iteration_state_smoother_input_args.jld")
    args = f["experiments"][j]
...
function iterative_smoother_state_exp(j)
    f = load("/data/gpfs/home/cgrudzien/da_benchmark/data/input_data/iterative_state_smoother_input_args.jld")
    args = f["experiments"][j]
