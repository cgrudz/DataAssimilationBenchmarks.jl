...
function process_all_smoother_state()
    ...
    # define the storage dictionary here
    data = Dict{String, Array{Float64,3}}(
                "etks_classic_anal_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_classic_anal_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_classic_filt_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_classic_filt_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_classic_fore_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_classic_fore_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_hybrid_anal_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_hybrid_anal_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_hybrid_filt_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_hybrid_filt_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_hybrid_fore_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "etks_hybrid_fore_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "ienks-bundle_anal_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "ienks-bundle_anal_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "ienks-bundle_filt_rmse"   => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
                "ienks-bundle_filt_spread" => Array{Float64}(undef, total_lag, total_inflation, ensemble_size),
    ...
    # create jld file name with relevant parameters
    jlname = "processed_all_smoother_state" * 
             "_diffusion_" * rpad(diffusion, 4, "0") *
             "_tanl_" * rpad(tanl, 4, "0") * 
             "_nanl_" * lpad(nanl, 5, "0") * 
             "_burn_" * lpad(burn, 5, "0") * 
    ...
    # create hdf5 file name with relevant parameters
    h5name = "processed_all_smoother_state" * 
             "_diffusion_" * rpad(diffusion, 4, "0") *
             "_tanl_" * rpad(tanl, 4, "0") * 
             "_nanl_" * lpad(nanl, 5, "0") * 
             "_burn_" * lpad(burn, 5, "0") * 
